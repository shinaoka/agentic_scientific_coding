...
Unpack the ZIP file and work inside the top-level folder. You do not need to
understand Git or repository management in detail at the beginning. However,
before asking an AI agent to edit files, read
[Minimal Git and diff safety](minimal-git-diff-safety.qmd). Git as a scientific
workflow tool is discussed later in
