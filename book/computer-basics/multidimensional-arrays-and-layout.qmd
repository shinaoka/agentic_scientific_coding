...
is a tenferro typed tensor, currently `tenferro_tensor::TypedTensor`, unless an
exercise explicitly asks for a flat-buffer implementation. `ndarray` is also
...
- Use tenferro typed tensors as the default Rust representation for 2D and
