...
Advanced exercise: Fork [this repository on GitHub](https://github.com/shinaoka/agentic_scientific_coding), clone your fork locally, make a small improvement to the lecture notes, push the change to your remote fork, and open one pull request. Before doing this exercise, look up fork, clone, remote, push, and pull request.
